...
POG_POM = [
    ...
    ("2024 LCK Spring", "POG points", "Doran", "HLE", 200, 200, "S2"),
    ...
    ("2024 LCK Summer", "POG points", "Doran", "HLE", 700, 700, "S3"),
    ...
    ("2025 LCK Rounds 3-5", "POM times", "Doran", "T1", 2, 200, "S5"),
    ...
    ("2025 KeSPA Cup", "POG points", "Doran", "T1", 0, 0, "S7"),
    ...
    ("2026 LCK Rounds 1-2 Snapshot", "POM points", "Doran", "T1", 100, 100, "S6"),
